...
#-----unigrams
print("///////////////////////Begin of creating *.unig file//////////")
...
print("///////////////////////End of creating *.unig file//////////")
...
print("///////////////////////End of creating finalunig files//////////")
...
print("///////////////////////Begin of writing term_freq_leaves.arff file//////////")
import re
numbers = re.compile(r'(\d+)')
def numericalSort(value):
    parts = numbers.split(value)
...
print("///////////////////////End of writing term_freq_leaves.arff file//////////")
...
import re
print("///////////////////////Begin of creating formatlf files//////////")
...
print("///////////////////////End of creating formatlf files//////////")

#--------------------------------------------makink finallf file

print("///////////////////////Begin of creating finallf files//////////")
...
print("///////////////////////End of creating finallf files//////////")


#-----------------------------------------------------------  all_leaves_finallf         

print("///////////////////////Begin of creating term_freq_leaf_all.txt file//////////")
...
print("///////////////////////End of creating term_freq_leaf_all.txt file//////////")
...
print("///////////////////////Begin of creating %s.inverself file//////////")
import math
import re
import itertools
...
#open('inverse_leaf_freq.arff', 'w').close()



##with open ("term_freq_unigrms_leaf_node.arff","a+") as myfile:
##
##    for inputf in sorted(glob.glob('*.finallf'), key=numericalSort):
##        termfr=[]
##        read = open(inputf, 'r')
##        result = [line.split('  =====  ') for line in read.readlines()]
##        for el in range(len(result)):
##            termfr.append(round(float(result[el][1]),3))
##        print(inputf,'Term frequency of leaf unigram=', termfr)
##
##        a = map(str, termfr)
##        line = ','.join(a)
##        myfile.write(line+','+str(inputf).rsplit('.', 1)[0][-4:][1:]+'\n')


        #tfidf=[round(a*b,3) for a,b in zip(termfr,invfr)]
        #print('Term frequency inverse document frequency=',tfidf)
...
print("///////////////////////End of creating %s.inverself file//////////")
...
print("///////////////////////Begin of creating %s.termfrinvfr file//////////")
...
print("///////////////////////End of creating %s.termfrinvfr file//////////")

#-------------write_tr_fr_inv_fr_leaves
import re
import itertools
...
print("///////////////////////Begin of creating term_fr_inv_fr_leaf.arff file//////////")
...
print("///////////////////////End of creating term_fr_inv_fr_leaf.arff file//////////")


print("We have term_fr_inv_fr_leaf.arff and term_freq_leaves.arff")
...
print("///////////////////////Begin of creating av_node_depth.arff file//////////")
...
print("///////////////////////End of creating av_node_depth.arff file//////////")
...
#------tern_freq_node
print("///////////////////////Begin of creating term_freq_node.arff file//////////")
...
for inputFilename1 in sorted(glob.glob('*.nf'), key=numericalSort):
    ...
    with open ("term_freq_node.arff","a+") as myfile:
       ...
       # myfile.write(ar1+","+str(inputFilename1).rsplit('.', 1)[0][-4:][1:]+"\n")
        ...
        myfile.close()
print("///////////////////////End of creating term_freq_node.arff file//////////")




print("///////////////////////Begin of creating %s.inversenf file//////////")
...
print("///////////////////////End of creating %s.inversenf file//////////")
...
#----inverse term node
print("///////////////////////Begin of creating .nodetermfrinvfr file//////////")
...
print("///////////////////////End of creating .nodetermfrinvfr file//////////")
...
print("///////////////////////Begin of creating term_fr_inv_fr_node.arff file//////////")
...
print("///////////////////////End of creating term_fr_inv_fr_node.arff file//////////")
#------------max depth

print("///////////////////////Begin of creating max_depth.arff file//////////")
...
print("///////////////////////End of creating max_depth.arff file//////////")


print("///////////////////////Begin of creating ast.arff file//////////")
#--- bigrams
...
print("///////////////////////End of creating ast.arff file//////////")
...
#print("///////////////////////Begin of creating keywords.arff file//////////")
...
#nocommentInputFile = 'AN1.com'

#parseFilename = 'AN1.txt'
...
#---------------------
    ...
    #a=[abstract,continue,for,new,switch,assert,default,goto,package,synchronized,boolean,do,if,private,this,break,double,implements,protected,throw,
     #byte,else,import,public,throws,case,enum,instanceof,return,transient,catch,extends,int,short,try,char,final,interface,static,void
...
#print("///////////////////////End of creating keywords.arff file//////////")
#number of unique keyword

#print("///////////////////////Begin of creating number_of_unique_keywords.arff file//////////")
import re
import itertools
import math
